...
The top 100 papers out of 1799, organized by category and ranked by quality score.

### ⚔️ Attacks & Adversaries

**#3** [Persistent Pre-Training Poisoning of LLMs](https://arxiv.org/abs/2410.13722)
Yiming Zhang et al. (8) · `A` · Score: 9.36 · 2024-10-17
...
Giorgio Piras et al. (6) · `A` · Score: 9.11 · 2025-11-11
...
Zhipeng Wei, Yuqi Liu, N. Benjamin Erichson · `A` · Score: 9.01 · 2024-11-01
...
Mintong Kang, Chejian Xu, Bo Li · `A` · Score: 9.00 · 2024-12-11
...
Brendan Murphy et al. (7) · `A` · Score: 8.86 · 2025-07-15
...
Milad Nasr et al. (14) · `A` · Score: 8.86 · 2025-10-10
...
Ziqi Miao et al. (4) · `A` · Score: 8.85 · 2025-07-03
...
Yukun Jiang et al. (4) · `A` · Score: 8.60 · 2025-10-24
...
Javad Rafiei Asl et al. (5) · `A` · Score: 8.57 · 2025-10-03
...
Samuele Poppi et al. (7) · `A` · Score: 8.55 · 2024-10-23
...
John Hughes et al. (10) · `A` · Score: 8.55 · 2024-12-04
...
Haolun Zheng et al. (9) · `A` · Score: 8.43 · 2026-03-22
...
Youze Wang et al. (6) · `A` · Score: 8.41 · 2025-06-02
...
Siyu Yan et al. (9) · `A` · Score: 8.39 · 2025-09-18
...
Mateusz Dziemian et al. (31) · `A` · Score: 8.38 · 2026-03-16
...
Peng Zhang, Peijie Sun · `A` · Score: 8.29 · 2025-11-10
> This paper proposes DBDI (Differentiated Bidirectional Intervention), a new white-box framework for precisely neutralizing the key layer safety alignment mechanisms of large language models. The research deconstructs the rejection mechanism into "harm detection direction" and "rejection execution direction," bypassing safety defenses through adaptive projection elimination and direct suppression. Experiments demonstrate that DBDI achieves a high attack success rate of up to 97.88% on models like Llama-2, offering a more fine-grained mechanistic framework for understanding LLM safety alignment.

**#96** [RAT: Adversarial Attacks on Deep Reinforcement Agents for Targeted Behaviors](https://arxiv.org/abs/2412.10713)
Fengshuo Bai et al. (5) · `A` · Score: 8.29 · 2024-12-14
> This paper introduces RAT, a general-purpose targeted behavior attack method for deep reinforcement learning agents. Unlike previous strategies that only focus on reducing rewards, RAT trains an intent policy aligned with human preferences and dynamically adjusts state occupancy metrics to induce the victim to execute specific behaviors that align with the attacker's goals. Experiments demonstrate that this method can effectively induce specific behaviors and enhance agent robustness in robotic simulation tasks.

**#99** [Chain-of-Thought Hijacking](https://arxiv.org/abs/2510.26418)
Jianli Zhao et al. (5) · `A` · Score: 8.27 · 2025-10-30
> This paper introduces the "Chain-of-Thought Hijacking" attack, revealing a vulnerability in large reasoning models where longer reasoning sequences can actually weaken security. By adding a long sequence of benign puzzle reasoning before a harmful instruction, the attack successfully bypasses the safety defenses of multiple mainstream models, achieving a very high attack success rate. Through activation probing and causal intervention analysis, the authors find that the rejection mechanism relies on a low-dimensional safety signal that gets diluted as the reasoning length increases, causing the model to fail to properly reject harmful requests.

### 🛡️ Defense & Alignment

**#5** [InfAlign: Inference-aware language model alignment](https://arxiv.org/abs/2412.19792)
Ananth Balashankar et al. (12) · `A` · Score: 9.17 · 2024-12-27
...
Tong Wu et al. (10) · `A` · Score: 9.16 · 2024-10-09
...
Deemah H. Tashman, Soumaya Cherkaoui · `A` · Score: 9.12 · 2026-03-27
...
Lei Yu et al. (4) · `A` · Score: 9.11 · 2024-09-30
...
Seanie Lee et al. (9) · `A` · Score: 9.00 · 2024-10-02
...
Shang Wang et al. (4) · `A` · Score: 8.94 · 2024-10-20
...
Yunhan Zhao et al. (6) · `A` · Score: 8.77 · 2024-10-28
...
Di Wu et al. (4) · `A` · Score: 8.75 · 2024-12-15
...
Guobin Shen et al. (5) · `A` · Score: 8.74 · 2024-10-03
...
Guorui Chen et al. (6) · `A` · Score: 8.68 · 2025-09-18
...
Tanqiu Jiang et al. (6) · `A` · Score: 8.63 · 2024-10-25
...
Yuxiao Li et al. (5) · `A` · Score: 8.61 · 2026-03-25
...
Ranjie Duan et al. (30) · `A` · Score: 8.56 · 2025-09-02
...
Christina Lu et al. (5) · `A` · Score: 8.54 · 2026-01-15
...
Soumya Suvra Ghosal et al. (10) · `A` · Score: 8.54 · 2024-11-27
...
Yue Huang et al. (14) · `A` · Score: 8.52 · 2025-10-10
...
Yizhu Wang et al. (5) · `A` · Score: 8.51 · 2025-10-22
...
Dongrui Liu et al. (43) · `A` · Score: 8.49 · 2026-01-26
...
Boyuan Zheng et al. (11) · `A` · Score: 8.46 · 2025-07-18
...
Masahiro Kaneko, Zeerak Talat, Timothy Baldwin · `A` · Score: 8.44 · 2025-10-19
...
Tom Pawelek et al. (7) · `A` · Score: 8.43 · 2025-09-23
...
Xiaomeng Hu, Pin-Yu Chen, Tsung-Yi Ho · `A` · Score: 8.38 · 2024-12-24
...
ShengYun Peng et al. (10) · `A` · Score: 8.36 · 2025-10-01
...
Xisen Jin et al. (7) · `A` · Score: 8.34 · 2026-03-06
...
Baturay Saglam et al. (6) · `A` · Score: 8.31 · 2025-07-13
...
Muzhi Dai et al. (6) · `A` · Score: 8.30 · 2025-07-29
> This paper proposes SecTOW, a reinforcement learning-based iterative defense-attack training framework designed to enhance the security of multimodal large language models. By engaging in iterative adversarial training between a defender and an auxiliary attacker, this method utilizes vulnerabilities found by the attacker to expand jailbreak data and train the defender, effectively tackling the issues of scarce training samples and the excessive rejection of harmless inputs.

**#92** [Reimagining Safety Alignment with An Image](https://arxiv.org/abs/2511.00509)
Yifan Xia et al. (6) · `A` · Score: 8.30 · 2025-11-01
> This paper introduces Magic Image, an optimization-based visual prompt framework designed to enhance the security of multimodal large models and reduce over-rejection. By optimizing image prompts, this method allows a single model to adapt to different value systems without parameter updates, achieving a better balance between security and performance.

**#100** [The VLLM Safety Paradox: Dual Ease in Jailbreak Attack and Defense](https://arxiv.org/abs/2411.08410)
Yangyang Guo et al. (4) · `A` · Score: 8.27 · 2024-11-13
> This paper explores the dual high-performance paradox in Visual Large Language Models (VLLMs) during jailbreak attacks and defenses, analyzing the vulnerabilities caused by visual inputs and the "over-cautious" problem in existing defense mechanisms. The authors propose the LLM-Pipeline method, which leverages the guardrails of an LLM as an effective detector to enhance the security of VLLMs.

### 📊 Security Evaluation

**#1** [MCPEval: Automatic MCP-based Deep Evaluation for AI Agent Models](https://arxiv.org/abs/2507.12806)
Zhiwei Liu et al. (12) · `A` · Score: 9.45 · 2025-07-17
...
Maksym Andriushchenko et al. (14) · `A` · Score: 9.37 · 2024-10-11
...
Hanrong Zhang et al. (8) · `A` · Score: 9.15 · 2024-10-03
...
Chengquan Guo et al. (8) · `A` · Score: 8.82 · 2024-11-12
...
Caitlin A. Stamatis et al. (6) · `A` · Score: 8.80 · 2026-01-14
...
Yinger Zhang et al. (9) · `A` · Score: 8.77 · 2026-01-26
...
Yutao Mou, Shikun Zhang, Wei Ye · `A` · Score: 8.77 · 2024-10-29
...
Hao Yang et al. (4) · `A` · Score: 8.72 · 2024-10-31
...
Zixin Chen et al. (8) · `A` · Score: 8.66 · 2025-07-02
...
Yunbei Zhang et al. (8) · `A` · Score: 8.63 · 2026-02-07
...
Andy Zou et al. (17) · `A` · Score: 8.61 · 2025-07-28
...
Sanidhya Vijayvargiya et al. (7) · `A` · Score: 8.61 · 2025-07-08
...
Sayash Kapoor et al. (31) · `A` · Score: 8.61 · 2025-10-13
...
Jingnan Zheng et al. (11) · `A` · Score: 8.60 · 2026-02-03
...
Priyanshu Kumar et al. (12) · `A` · Score: 8.53 · 2024-10-11
...
Tarek Gasmi et al. (4) · `A` · Score: 8.51 · 2025-07-08
...
Xuhui Zhou et al. (12) · `A` · Score: 8.49 · 2024-09-24
...
Yuhang Wang et al. (9) · `A` · Score: 8.45 · 2026-02-09
...
David Schmotz et al. (4) · `A` · Score: 8.43 · 2026-02-23
...
Zhexin Zhang et al. (7) · `A` · Score: 8.42 · 2024-12-19
...
Mahmoud Mohammadi et al. (4) · `A` · Score: 8.40 · 2025-07-29
...
Pengcheng Li et al. (8) · `A` · Score: 8.40 · 2026-03-15
...
Kaiwen Zhou et al. (6) · `A` · Score: 8.40 · 2024-10-08
...
Xiaojun Jia et al. (14) · `A` · Score: 8.38 · 2025-12-06
...
Hao Li et al. (5) · `A` · Score: 8.34 · 2026-02-03
...
Tongbo Chen et al. (16) · `A` · Score: 8.34 · 2026-04-09
...
Fangzhi Xu et al. (19) · `A` · Score: 8.33 · 2026-02-05
...
Sagnik Anupam et al. (6) · `A` · Score: 8.32 · 2025-10-02
...
Shiva Krishna Reddy Malay et al. (9) · `A` · Score: 8.30 · 2026-03-13
> This paper introduces the EnterpriseOps-Gym benchmark, designed to evaluate an Agent's planning and tool-use capabilities in real-world enterprise environments. Featuring numerous databases and tools, the benchmark tested the performance of 14 state-of-the-art models on long-term planning and state changes, revealing critical limitations of current Agents in strategic reasoning and rejecting infeasible tasks. It provides a concrete testing platform for enhancing the robustness of Agents in enterprise deployments.
...
Yu Yan et al. (9) · `A` · Score: 8.28 · 2025-08-22
> This paper re-examines jailbreak evaluation by decoupling jailbreaking techniques and constructing knowledge-intensive question-answering tasks to study the real-world abuse threats of LLMs, such as their possession of dangerous knowledge and harmful task planning capabilities. Experiments reveal a mismatch between jailbreak success rates and the possession of harmful knowledge, indicating that existing evaluation frameworks often anchor on toxic language patterns rather than real-world threats.
...
Hengyu An et al. (7) · `A` · Score: 9.33 · 2025-08-21
...
Guibin Zhang et al. (9) · `A` · Score: 9.06 · 2024-10-15
...
Jianzhao Huang et al. (6) · `A` · Score: 8.97 · 2024-11-08
...
Ziyan Liu et al. (5) · `A` · Score: 8.93 · 2025-07-09
...
Saeid Jamshidi et al. (6) · `A` · Score: 8.92 · 2025-12-06
...
Guibin Zhang et al. (9) · `A` · Score: 8.91 · 2024-10-03
...
Zhilun Zhou et al. (8) · `A` · Score: 8.90 · 2026-01-08
...
Nils Palumbo et al. (5) · `A` · Score: 8.89 · 2026-02-18
...
Zonghao Ying et al. (10) · `A` · Score: 8.83 · 2026-03-13
...
Yutao Mou et al. (7) · `A` · Score: 8.82 · 2026-01-15
...
Aarya Doshi et al. (6) · `A` · Score: 8.79 · 2026-01-12
...
Feiran Jia et al. (4) · `A` · Score: 8.67 · 2024-12-21
...
Qiushi Sun et al. (14) · `A` · Score: 8.57 · 2025-10-28
...
Lesly Miculicich et al. (7) · `A` · Score: 8.57 · 2025-10-03
...
Adharsh Kamath et al. (6) · `A` · Score: 8.54 · 2025-12-25
...
Yi Nian et al. (6) · `A` · Score: 8.49 · 2026-03-18
...
Vincent Siu et al. (7) · `A` · Score: 8.33 · 2026-03-19
...
Shuai Shao et al. (11) · `A` · Score: 8.28 · 2025-09-30
> This paper investigates the "erroneous evolution" risk in self-evolving LLM agents, where agents deviate from their intended trajectory during self-improvement, leading to harmful outcomes. By evaluating four evolution paths—model, memory, tools, and workflow—the study finds that agents built even on top-tier LLMs commonly face risks such as safety alignment degradation. This highlights the urgency of establishing new security paradigms to address the potential threats of self-evolving agents.

### 📄 Other Topics

**#11** [SPA-Bench: A Comprehensive Benchmark for SmartPhone Agent Evaluation](https://arxiv.org/abs/2410.15164)
Jingxuan Chen et al. (17) · `A` · Score: 9.11 · 2024-10-19
...
Anshuman Chhabra et al. (4) · `A` · Score: 8.79 · 2025-10-27
...
Juhee Kim et al. (7) · `A` · Score: 8.39 · 2026-03-11
...
Crystal Qian et al. (7) · `A` · Score: 8.36 · 2025-09-11
...
Chen Xiong et al. (5) · `A` · Score: 8.33 · 2026-02-03
...
Ryan Li, Yanzhe Zhang, Diyi Yang · `A` · Score: 8.30 · 2024-10-21
> This paper proposes the Sketch2Code benchmark to evaluate the ability of Visual Language Models (VLMs) to convert sketches into web prototypes. The benchmark supports interactive agent evaluations that simulate real design workflows and analyzes the performance of ten commercial and open-source models. It reveals that existing models still struggle with accurately interpreting sketches and asking effective questions, highlighting the necessity of developing multi-turn conversational agents.
